...
export type TagsWithCountsQuery = {
  __typename: 'Query';
  tags: Array<{
    __typename: 'Tag';
    noteCount: number;
...
export type VisitedNotesQuery = {
  __typename: 'Query';
  notes: Array<
    | { __typename: 'Link'; _id: string; name: string }
    | { __typename: 'Text'; _id: string; name: string }
  >;
};
...
export type UnshareTagMutation = {
  __typename: 'Mutation';
  unshareTag: {
    __typename: 'Tag';
    _id: string;
...
export type UpdatePermissionOnTagMutation = {
  __typename: 'Mutation';
  ...
  removeTagByIdFromNote:
    | {
        ...
        tags: Array<{
          ...
          color: string;
          notes?: Array<
            | { __typename: 'Link'; _id: string }
            | { __typename: 'Text'; _id: string }
            | null
          > | null;
          user: { __typename: 'User'; _id: string; name: string };
          permissions: Array<{
...
export type TitleSuggestionsQuery = {
  __typename: 'Query';
...
export type TinyUserQuery = {
  __typename: 'Query';
  currentUser?: { __typename: 'User'; _id: string } | null;
};
  ...
  permanentlyDeleteTag: {
    ...
    notes?: Array<
      | {
          __typename: 'Link';
          _id: string;
          tags: Array<{ __typename: 'Tag'; _id: string }>;
        }
      | {
          __typename: 'Text';
          _id: string;
...
export type UpdateTag2Mutation = {
  __typename: 'Mutation';
  updateTag: {
    __typename: 'Tag';
    _id: string;
...
export type UserCredentialsFragmentFragment = {
  __typename: 'User';
  _id: string;
  credentials?: {
    __typename: 'Credentials';
...
export type RequestNewCredentialMutation = {
  __typename: 'Mutation';
...
export type RevokeCredentialMutation = {
  __typename: 'Mutation';
  revokeCredential: {
    __typename: 'User';
    _id: string;
...
export type ToggleDeletedNoteMutation = {
  __typename: 'Mutation';
  toggleDeletedNote:
    | { __typename: 'Link'; _id: string; deletedAt?: any | null }
    | { __typename: 'Text'; _id: string; deletedAt?: any | null };
};
...
export type UpdatedNotesCacheQueryQueryVariables = Exact<{
  [key: string]: never;
}>;
...
export type TagWithNoteIdsQuery = {
  __typename: 'Query';
  tag: {
    __typename: 'Tag';
    _id: string;
...
export type ToggleArchivedNoteMutation = {
  __typename: 'Mutation';
  toggleArchivedNote:
    | { __typename: 'Link'; _id: string; archivedAt?: any | null }
    | { __typename: 'Text'; _id: string; archivedAt?: any | null };
};
...
export type ProfileQuery = {
  __typename: 'Query';
  currentUser?: { __typename: 'User'; _id: string; name: string } | null;
  versions: {
    __typename: 'Versions';
    current: string;
    minimum?: string | null;
...
export type AddTagByNameToNoteMutation = {
  __typename: 'Mutation';
  addTagByNameToNote:
    | {
        __typename: 'Link';
 ...
 * });
 */
export function useTagsWithCountsQuery(
  baseOptions?: Apollo.QueryHookOptions<
    TagsWithCountsQuery,
    TagsWithCountsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<TagsWithCountsQuery, TagsWithCountsQueryVariables>(
    TagsWithCountsDocument,
    options
  );
}
export function useTagsWithCountsLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<TagsWithCountsQuery, TagsWithCountsQueryVariables>(
    TagsWithCountsDocument,
    options
  );
}
export type TagsWithCountsQueryHookResult = ReturnType<
  typeof useTagsWithCountsQuery
>;
export type TagsWithCountsLazyQueryHookResult = ReturnType<
  typeof useTagsWithCountsLazyQuery
>;
export type TagsWithCountsQueryResult = Apollo.QueryResult<
  TagsWithCountsQuery,
  TagsWithCountsQueryVariables
>;
 ...
 * });
 */
export function useVisitedNotesQuery(
  baseOptions?: Apollo.QueryHookOptions<
    VisitedNotesQuery,
    VisitedNotesQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<VisitedNotesQuery, VisitedNotesQueryVariables>(
    VisitedNotesDocument,
    options
  );
}
export function useVisitedNotesLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    VisitedNotesQuery,
    VisitedNotesQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<VisitedNotesQuery, VisitedNotesQueryVariables>(
    VisitedNotesDocument,
    options
  );
}
export type VisitedNotesQueryHookResult = ReturnType<
  typeof useVisitedNotesQuery
>;
export type VisitedNotesLazyQueryHookResult = ReturnType<
  typeof useVisitedNotesLazyQuery
>;
export type VisitedNotesQueryResult = Apollo.QueryResult<
  VisitedNotesQuery,
  VisitedNotesQueryVariables
>;
...
`;
export type ShareTagMutationFn = Apollo.MutationFunction<
  ShareTagMutation,
 ...
 * });
 */
export function useShareTagMutation(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<ShareTagMutation, ShareTagMutationVariables>(
    ShareTagDocument,
    options
  );
}
...
export type ShareTagMutationOptions = Apollo.BaseMutationOptions<
  ShareTagMutation,
  ShareTagMutationVariables
>;
...
`;
export type UnshareTagMutationFn = Apollo.MutationFunction<
  UnshareTagMutation,
 ...
 * });
 */
export function useUnshareTagMutation(
  baseOptions?: Apollo.MutationHookOptions<
    UnshareTagMutation,
    UnshareTagMutationVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<UnshareTagMutation, UnshareTagMutationVariables>(
    UnshareTagDocument,
    options
  );
}
export type UnshareTagMutationHookResult = ReturnType<
  typeof useUnshareTagMutation
>;
export type UnshareTagMutationResult =
  Apollo.MutationResult<UnshareTagMutation>;
export type UnshareTagMutationOptions = Apollo.BaseMutationOptions<
  UnshareTagMutation,
  UnshareTagMutationVariables
>;
...
`;
export type UpdatePermissionOnTagMutationFn = Apollo.MutationFunction<
 ...
 * });
 */
export function useUpdatePermissionOnTagMutation(
  baseOptions?: Apollo.MutationHookOptions<
    UpdatePermissionOnTagMutation,
    UpdatePermissionOnTagMutationVariables
  >
  ...
  return Apollo.useMutation<
    UpdatePermissionOnTagMutation,
    UpdatePermissionOnTagMutationVariables
  >(UpdatePermissionOnTagDocument, options);
}
export type UpdatePermissionOnTagMutationHookResult = ReturnType<
  typeof useUpdatePermissionOnTagMutation
>;
export type UpdatePermissionOnTagMutationResult =
  Apollo.MutationResult<UpdatePermissionOnTagMutation>;
export type UpdatePermissionOnTagMutationOptions = Apollo.BaseMutationOptions<
  UpdatePermissionOnTagMutation,
  UpdatePermissionOnTagMutationVariables
>;
export const RemoveTagByIdFromNoteDocument = gql`
  ...
  ${BaseTagFragmentDoc}
`;
export type RemoveTagByIdFromNoteMutationFn = Apollo.MutationFunction<
 ...
 * });
 */
export function useRemoveTagByIdFromNoteMutation(
  baseOptions?: Apollo.MutationHookOptions<
    RemoveTagByIdFromNoteMutation,
    RemoveTagByIdFromNoteMutationVariables
  >
  ...
  return Apollo.useMutation<
    RemoveTagByIdFromNoteMutation,
    RemoveTagByIdFromNoteMutationVariables
  >(RemoveTagByIdFromNoteDocument, options);
}
export type RemoveTagByIdFromNoteMutationHookResult = ReturnType<
  typeof useRemoveTagByIdFromNoteMutation
>;
export type RemoveTagByIdFromNoteMutationResult =
  Apollo.MutationResult<RemoveTagByIdFromNoteMutation>;
export type RemoveTagByIdFromNoteMutationOptions = Apollo.BaseMutationOptions<
  RemoveTagByIdFromNoteMutation,
  RemoveTagByIdFromNoteMutationVariables
>;
 ...
 * });
 */
export function useTitleSuggestionsQuery(
  baseOptions: Apollo.QueryHookOptions<
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<TitleSuggestionsQuery, TitleSuggestionsQueryVariables>(
    TitleSuggestionsDocument,
    options
  );
}
export function useTitleSuggestionsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    TitleSuggestionsQuery,
    TitleSuggestionsQueryVariables
  >
  ...
  return Apollo.useLazyQuery<
    TitleSuggestionsQuery,
    TitleSuggestionsQueryVariables
  >(TitleSuggestionsDocument, options);
}
export type TitleSuggestionsQueryHookResult = ReturnType<
  typeof useTitleSuggestionsQuery
>;
export type TitleSuggestionsLazyQueryHookResult = ReturnType<
  typeof useTitleSuggestionsLazyQuery
>;
export type TitleSuggestionsQueryResult = Apollo.QueryResult<
  TitleSuggestionsQuery,
  TitleSuggestionsQueryVariables
>;
 ...
 * });
 */
export function useNotesForListQuery(
  baseOptions?: Apollo.QueryHookOptions<
    NotesForListQuery,
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<NotesForListQuery, NotesForListQueryVariables>(
    NotesForListDocument,
    options
  );
}
export function useNotesForListLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    NotesForListQuery,
    NotesForListQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<NotesForListQuery, NotesForListQueryVariables>(
    NotesForListDocument,
    options
  );
}
export type NotesForListQueryHookResult = ReturnType<
  typeof useNotesForListQuery
>;
export type NotesForListLazyQueryHookResult = ReturnType<
  typeof useNotesForListLazyQuery
>;
export type NotesForListQueryResult = Apollo.QueryResult<
  NotesForListQuery,
  NotesForListQueryVariables
>;
...
export function useTinyUserQuery(
  baseOptions?: Apollo.QueryHookOptions<TinyUserQuery, TinyUserQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<TinyUserQuery, TinyUserQueryVariables>(
    TinyUserDocument,
    options
  );
}
export function useTinyUserLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    TinyUserQuery,
    TinyUserQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<TinyUserQuery, TinyUserQueryVariables>(
    TinyUserDocument,
    options
  );
}
export type TinyUserQueryHookResult = ReturnType<typeof useTinyUserQuery>;
export type TinyUserLazyQueryHookResult = ReturnType<
  typeof useTinyUserLazyQuery
>;
export type TinyUserQueryResult = Apollo.QueryResult<
  TinyUserQuery,
  TinyUserQueryVariables
>;
 ...
 * });
 */
export function useTagWithNotesQuery(
  baseOptions: Apollo.QueryHookOptions<
    TagWithNotesQuery,
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<TagWithNotesQuery, TagWithNotesQueryVariables>(
    TagWithNotesDocument,
    options
  );
}
export function useTagWithNotesLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    TagWithNotesQuery,
    TagWithNotesQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<TagWithNotesQuery, TagWithNotesQueryVariables>(
    TagWithNotesDocument,
    options
  );
}
export type TagWithNotesQueryHookResult = ReturnType<
  typeof useTagWithNotesQuery
>;
export type TagWithNotesLazyQueryHookResult = ReturnType<
  typeof useTagWithNotesLazyQuery
>;
export type TagWithNotesQueryResult = Apollo.QueryResult<
  TagWithNotesQuery,
  TagWithNotesQueryVariables
>;
...
export const UpdateTag2Document = gql`
  ...
  ${BaseTagFragmentDoc}
`;
export type UpdateTag2MutationFn = Apollo.MutationFunction<
  UpdateTag2Mutation,
 ...
 * });
 */
export function useUpdateTag2Mutation(
  baseOptions?: Apollo.MutationHookOptions<
    UpdateTag2Mutation,
    UpdateTag2MutationVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<UpdateTag2Mutation, UpdateTag2MutationVariables>(
    UpdateTag2Document,
    options
  );
}
export type UpdateTag2MutationHookResult = ReturnType<
  typeof useUpdateTag2Mutation
>;
export type UpdateTag2MutationResult =
  Apollo.MutationResult<UpdateTag2Mutation>;
export type UpdateTag2MutationOptions = Apollo.BaseMutationOptions<
  UpdateTag2Mutation,
  UpdateTag2MutationVariables
>;
...
export function useTextQuery(
  baseOptions?: Apollo.QueryHookOptions<TextQuery, TextQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<TextQuery, TextQueryVariables>(TextDocument, options);
}
export function useTextLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<TextQuery, TextQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<TextQuery, TextQueryVariables>(
    TextDocument,
    options
  );
}
...
export function useUserCredentialsQuery(
  baseOptions?: Apollo.QueryHookOptions<
    ...
    UserCredentialsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<UserCredentialsQuery, UserCredentialsQueryVariables>(
    UserCredentialsDocument,
    options
  );
}
export function useUserCredentialsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    UserCredentialsQuery,
    UserCredentialsQueryVariables
  >
  ...
  return Apollo.useLazyQuery<
    UserCredentialsQuery,
    UserCredentialsQueryVariables
  >(UserCredentialsDocument, options);
}
export type UserCredentialsQueryHookResult = ReturnType<
  typeof useUserCredentialsQuery
>;
export type UserCredentialsLazyQueryHookResult = ReturnType<
  typeof useUserCredentialsLazyQuery
>;
export type UserCredentialsQueryResult = Apollo.QueryResult<
  UserCredentialsQuery,
  UserCredentialsQueryVariables
>;
export const RequestNewCredentialDocument = gql`
  ...
  ${UserCredentialsFragmentFragmentDoc}
`;
export type RequestNewCredentialMutationFn = Apollo.MutationFunction<
 ...
 * });
 */
export function useRequestNewCredentialMutation(
  baseOptions?: Apollo.MutationHookOptions<
    RequestNewCredentialMutation,
    RequestNewCredentialMutationVariables
  >
  ...
  return Apollo.useMutation<
    RequestNewCredentialMutation,
    RequestNewCredentialMutationVariables
  >(RequestNewCredentialDocument, options);
}
export type RequestNewCredentialMutationHookResult = ReturnType<
  typeof useRequestNewCredentialMutation
>;
export type RequestNewCredentialMutationResult =
  Apollo.MutationResult<RequestNewCredentialMutation>;
export type RequestNewCredentialMutationOptions = Apollo.BaseMutationOptions<
  RequestNewCredentialMutation,
  RequestNewCredentialMutationVariables
>;
export const RevokeCredentialDocument = gql`
  ...
  ${UserCredentialsFragmentFragmentDoc}
`;
export type RevokeCredentialMutationFn = Apollo.MutationFunction<
...
export function useRevokeCredentialMutation(
  ...
  return Apollo.useMutation<
    RevokeCredentialMutation,
    RevokeCredentialMutationVariables
  >(RevokeCredentialDocument, options);
}
export type RevokeCredentialMutationHookResult = ReturnType<
  typeof useRevokeCredentialMutation
>;
export type RevokeCredentialMutationResult =
  Apollo.MutationResult<RevokeCredentialMutation>;
export type RevokeCredentialMutationOptions = Apollo.BaseMutationOptions<
  RevokeCredentialMutation,
  RevokeCredentialMutationVariables
>;
...
`;
export type ToggleDeletedNoteMutationFn = Apollo.MutationFunction<
 ...
 * });
 */
export function useToggleDeletedNoteMutation(
  baseOptions?: Apollo.MutationHookOptions<
    ToggleDeletedNoteMutation,
    ToggleDeletedNoteMutationVariables
  >
  ...
  return Apollo.useMutation<
    ToggleDeletedNoteMutation,
    ToggleDeletedNoteMutationVariables
  >(ToggleDeletedNoteDocument, options);
}
export type ToggleDeletedNoteMutationHookResult = ReturnType<
  typeof useToggleDeletedNoteMutation
>;
export type ToggleDeletedNoteMutationResult =
  Apollo.MutationResult<ToggleDeletedNoteMutation>;
export type ToggleDeletedNoteMutationOptions = Apollo.BaseMutationOptions<
  ToggleDeletedNoteMutation,
  ToggleDeletedNoteMutationVariables
>;
 ...
 * });
 */
export function useEntitiesUpdatedSinceQuery(
  baseOptions?: Apollo.QueryHookOptions<
  ...
  return Apollo.useQuery<
    EntitiesUpdatedSinceQuery,
    EntitiesUpdatedSinceQueryVariables
  >(EntitiesUpdatedSinceDocument, options);
}
export function useEntitiesUpdatedSinceLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    EntitiesUpdatedSinceQuery,
    EntitiesUpdatedSinceQueryVariables
  >
...
export type EntitiesUpdatedSinceQueryHookResult = ReturnType<
  typeof useEntitiesUpdatedSinceQuery
>;
export type EntitiesUpdatedSinceLazyQueryHookResult = ReturnType<
  typeof useEntitiesUpdatedSinceLazyQuery
>;
export type EntitiesUpdatedSinceQueryResult = Apollo.QueryResult<
  EntitiesUpdatedSinceQuery,
  EntitiesUpdatedSinceQueryVariables
>;
 ...
 * });
 */
export function useUpdatedNotesCacheQueryQuery(
  baseOptions?: Apollo.QueryHookOptions<
    UpdatedNotesCacheQueryQuery,
    UpdatedNotesCacheQueryQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    UpdatedNotesCacheQueryQuery,
    UpdatedNotesCacheQueryQueryVariables
  >(UpdatedNotesCacheQueryDocument, options);
}
export function useUpdatedNotesCacheQueryLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    UpdatedNotesCacheQueryQuery,
    UpdatedNotesCacheQueryQueryVariables
  >
...
export type UpdatedNotesCacheQueryQueryHookResult = ReturnType<
  typeof useUpdatedNotesCacheQueryQuery
>;
export type UpdatedNotesCacheQueryLazyQueryHookResult = ReturnType<
  typeof useUpdatedNotesCacheQueryLazyQuery
>;
export type UpdatedNotesCacheQueryQueryResult = Apollo.QueryResult<
  UpdatedNotesCacheQueryQuery,
  UpdatedNotesCacheQueryQueryVariables
>;
 ...
 * });
 */
export function useTagWithNoteIdsQuery(
  baseOptions: Apollo.QueryHookOptions<
    TagWithNoteIdsQuery,
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<TagWithNoteIdsQuery, TagWithNoteIdsQueryVariables>(
    TagWithNoteIdsDocument,
    options
  );
}
export function useTagWithNoteIdsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    TagWithNoteIdsQuery,
    TagWithNoteIdsQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<TagWithNoteIdsQuery, TagWithNoteIdsQueryVariables>(
    TagWithNoteIdsDocument,
    options
  );
}
export type TagWithNoteIdsQueryHookResult = ReturnType<
  typeof useTagWithNoteIdsQuery
>;
export type TagWithNoteIdsLazyQueryHookResult = ReturnType<
  typeof useTagWithNoteIdsLazyQuery
>;
export type TagWithNoteIdsQueryResult = Apollo.QueryResult<
  TagWithNoteIdsQuery,
  TagWithNoteIdsQueryVariables
>;
...
`;
export type ToggleArchivedNoteMutationFn = Apollo.MutationFunction<
 ...
 * });
 */
export function useToggleArchivedNoteMutation(
  baseOptions?: Apollo.MutationHookOptions<
    ToggleArchivedNoteMutation,
    ToggleArchivedNoteMutationVariables
  >
  ...
  return Apollo.useMutation<
    ToggleArchivedNoteMutation,
    ToggleArchivedNoteMutationVariables
  >(ToggleArchivedNoteDocument, options);
}
export type ToggleArchivedNoteMutationHookResult = ReturnType<
  typeof useToggleArchivedNoteMutation
>;
export type ToggleArchivedNoteMutationResult =
  Apollo.MutationResult<ToggleArchivedNoteMutation>;
export type ToggleArchivedNoteMutationOptions = Apollo.BaseMutationOptions<
  ToggleArchivedNoteMutation,
  ToggleArchivedNoteMutationVariables
>;
...
export const AddTextDocument = gql`
  ...
  ${BaseNoteFragmentDoc}
`;
export type AddTextMutationFn = Apollo.MutationFunction<
  AddTextMutation,
...
export function useAddTextMutation(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<AddTextMutation, AddTextMutationVariables>(
    AddTextDocument,
    options
  );
}
...
export type AddTextMutationOptions = Apollo.BaseMutationOptions<
  AddTextMutation,
  AddTextMutationVariables
>;
export const AddTagByNameToNoteDocument = gql`
  ...
  ${BaseTagFragmentDoc}
`;
export type AddTagByNameToNoteMutationFn = Apollo.MutationFunction<
 ...
 * });
 */
export function useAddTagByNameToNoteMutation(
  baseOptions?: Apollo.MutationHookOptions<
    AddTagByNameToNoteMutation,
    AddTagByNameToNoteMutationVariables
  >
  ...
  return Apollo.useMutation<
    AddTagByNameToNoteMutation,
    AddTagByNameToNoteMutationVariables
  >(AddTagByNameToNoteDocument, options);
}
export type AddTagByNameToNoteMutationHookResult = ReturnType<
  typeof useAddTagByNameToNoteMutation
>;
export type AddTagByNameToNoteMutationResult =
  Apollo.MutationResult<AddTagByNameToNoteMutation>;
export type AddTagByNameToNoteMutationOptions = Apollo.BaseMutationOptions<
  AddTagByNameToNoteMutation,
  AddTagByNameToNoteMutationVariables
>;
